...
export default function ProgressScreen() {
  ...
  return <Screen title="Progress" subtitle="Consistency you can see">
    ...
    <View style={s.metrics}><MetricCard label="Training time" value="14 hr 30 min" detail="This month" /><MetricCard label="Training days" value="12" detail="This month" /></View>
...
const s = StyleSheet.create({
  row: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, metrics: { flexDirection: 'row', gap: spacing.md, marginTop: spacing.md }, chartCard: { height: 184 },
  ...
  bar: { width: 32, borderTopLeftRadius: 10, borderTopRightRadius: 10 }, highlight: { minHeight: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
